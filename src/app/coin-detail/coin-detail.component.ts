...
export class CoinDetailComponent implements OnInit {
  ...
  constructor(private coinApiService : CoinApiService, private activatedRoute : ActivatedRoute, private currencyService : CurrencyService) { }
  ...
  getCoinData(){
    this.coinApiService.getCurrencyById(this.coinId)
    .subscribe(res=>{
  ...
  getGraphData(days:number){
    this.days = days
    this.coinApiService.getGrpahicalCurrencyData(this.coinId,this.currency,this.days)
    .subscribe(res=>{
      setTimeout(() => {
